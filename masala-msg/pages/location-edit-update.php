...
echo $locationID."id<br>";
echo $locationName."location<br>";
echo $locationhouseNo."houseNo<br>";
...
$sql="INSERT INTO location (location_name, location_houseno,location_soi,location_road,location_District,location_Province,location_postno,location_area,img_status,location_img , location_count, location_contact_name, location_contact_phone, location_category_id,Location_isActive,location_update_id,location_create_id,location_update_time)
VALUES ('$locationName',
        '$locationhouseNo',
        '$locationsoi',
        '$locationroad',
